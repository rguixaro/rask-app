...
export const Badge = (props: BadgeProps) => {
	return (
		<span className='relative inline-block overflow-hidden rounded-full p-[1px] font-mono'>
			...
			<div
				className={cn(
					'inline-flex h-full w-full cursor-default items-center justify-center rounded-full border px-3 py-1 text-xs font-medium bg-forest-600 border-neutral-800 text-white',
					props.className
				)}>
				{props.children}
			</div>
